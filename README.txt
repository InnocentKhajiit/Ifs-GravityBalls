Реализована функциональность в соответствии со списком задач, разработаны классы WorldModel и Vector2.
Из-за заданых интерфейсов взаимодействия с WorldModel пришлось оставить публичные поля.
